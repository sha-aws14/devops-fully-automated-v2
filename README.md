...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/sha-aws14/devops-fully-automated-v2)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated" (https://github.com/sha-aws14/devops-fully-automated-v2) & name it "devops-fully-automated"**
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/sha-aws14/devops-fully-automated-v2/blob/installations/nexus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/sha-aws14/devops-fully-automated-v2/blob/installations/grafana-setup.sh
    - Launch Instance
...
1) #### SonarQube IP change
    - Go back to your local, open your "devops-fully-automated" project on VSCODE (in git bash, in desktop location, type " git clone pasterepourl")
    - Open "Jenkinsfile" & Replace the SonarQube server private ip on line number 69, make sure git url is correct on line 22
